                      ...
                      <div class="col-md-3">
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                              <label>Article</label>
                              <select class="article form-control" onchange="getPrixUnitaireArticle();getReferenceArticle();">
                                <option value=""></option>
                          ...
                          <div class="col-md-3">
                            ...
                            <input type="text" name="" placeholder="reference " class="reference form-control" disabled="true"  >
                          </div>
                          <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                            ...
                            <select class="id_fournisseur form-control" onchange="" disabled="true">
