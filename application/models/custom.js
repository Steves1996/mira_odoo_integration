...
function sendMessage(){
    ...
    jQuery.ajax({
      type:"POST",
      url:"https://smsvas.com/bulk/public/index.php/api/v1/sendsms?user=lmanga@positivaris-investment.com&password=lucienmang&senderid=SELLCIOO&sms="+message+"&mobiles="+telephone,
      data:{},
