...
function addLivraison(status){
  ...
  // alert($(".arrivee").val());
	...
	$.ajax({
		      ...
		      data:{"tva":tva,"commentaire":commentaire,"operation":operation,"code_camion":code_camion,"unite":unite,"status":status,"id_BL":id_BL,"numero":numero,"dateLivraison":dateLivraison,"depart":depart,"arrivee":arrivee,"quantite":quantite,"PU":PU},
...
function infosLivraison(numero,dateLivraison,depart,quantite,PU,id_BL,commentaire,code_camion,id_distance,unite,id_operation,tva,PU1){
	$(".unite").val(unite);
  $(".tva").val(tva);
