...
class Admin_fournisseur_gazoil extends CI_Controller{
    ...
    public function addFournisseurGazoil(){
        $this->crud_model_fournisseur_gazoil->addFournisseurGazoil();
    }
    public function getAllFournisseurGazoil(){
        $this->crud_model_fournisseur_gazoil->selectAllFournisseurGazoil();
    }

    public function deleteFournisseurGasoil(){
        $table = $_POST["table"];
        $identifiant = $_POST["identifiant"];
        $nom_id = $_POST["nom_id"];
        $this->crud_model_depense->deleteFournisseurGasoil($table, $identifiant, $nom_id);
    }
}