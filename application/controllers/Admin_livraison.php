...
class Admin_livraison extends CI_Controller{
    ...
    public function getDescriptionOperation(){
	 ...
	 public function getTotalBL(){
        $this->crud_model_livraison->getTotalBL();
    }
	...
	public function getImmatriculation(){
        $this->crud_model_livraison->getImmatriculationCode();
    }
    ...
    public function deleteBonLivraison(){
        ...
        $nom_id = $_POST["nom_id"];
        $this->crud_model_livraison->deleteBonLivraison($table, $identifiant, $nom_id);
    }

    public function deleteVentePiece(){
        $table = $_POST["table"];
        $identifiant = $_POST["identifiant"];
        $nom_id = $_POST["nom_id"];
        $this->crud_model_livraison->deleteVentePiece($table, $identifiant, $nom_id);
    }
}