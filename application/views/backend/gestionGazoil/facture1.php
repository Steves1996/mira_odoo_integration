                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            ...
                            <select class="id_fournisseur form-control" onchange="leSelectGazoilParFournisseur();">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                            <label>Bon gazoil</label>
                            <select class="id_gazoil form-control" onchange="getMontant();">
                             
                              <!-- <?php $this->crud_model_gestion_gazoil->leSelectGazoil(); ?> -->
                          ...
                          <div class="col-md-3">
                             <label>numéro</label>
                            <input type="text" class="form-control numero" placeholder="numero">
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-4">
                           <label>Montant</label>
                            <input type="text" class="form-control montant" disabled="true" placeholder=" en FCFA" onkeypress="chiffres(event);" onkeyup ="formatMillier('montant');">
                          ...
                          echo ' <button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addFactureGazoil(\'insert\');">Valider</button>'; } ?></div>
                        </div>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: FACTURE GAZOIL'
            },
            {
            extend: "pdf",
