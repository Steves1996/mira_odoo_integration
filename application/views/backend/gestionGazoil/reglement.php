                       ...
                       <div class="col-md-3">
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-4">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addReglement('update');">Modifier</button>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addReglement(\'insert\');">Valider</button>'; } ?></div>
                        </div>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: REGLEMENT GAZOIL'
            },
            {
            extend: "pdf",
