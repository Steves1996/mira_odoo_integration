                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <select class="id_fournisseur form-control" onchange="getBalanceFacture();">
                             <option value=""></option>
                          ...
                          <div class="col-md-12 initial">
                            ...
                            <div class="form-group">
                            <label>Solde</label>
                            <input type="text" class="form-control soldeInitial" disabled="true" name="">
                          </div>
                          <div class="form-group">
                            <label>Date</label>
                            <div class="input-group " id="" data-target-input="nearest" >
                              
                                <input type="text" class="form-control dateInitial" data-target="#reservationdate" disabled="true" />
                     ...
                     <div class="card card-warning">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">          
                            Factures : <input type="text" disabled="true" class="totalFacture form-control" name="">
                            Règlement : <input type="text" disabled="true"  class="totalReglement form-control" name="">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceFacture();"/>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceFacture();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
