                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <select class="type form-control" autocomplete='on' onchange ="">
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addFactureGazoil('update');">Modifier</button>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addFactureGazoil(\'insert\');">Valider</button>'; 
						  ?></div>
                        </div>
