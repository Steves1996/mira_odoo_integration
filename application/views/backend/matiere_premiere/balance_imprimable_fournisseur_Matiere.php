...
<head>
 ...
 $balanceImprimeFournisseurMatiere=""; 
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              <li class="breadcrumb-item"><a href="#">Homefff</a></li>
              ...
              <div id="selectionAimprier" style="margin: 30px;"> 
                 ...
                 <!--  <tr style=" margin: 0px;">
                  ...
                  <tr style="border: 2px solid black; color: red;">
					...
					<th style="border: 2px solid black; color: red;">N°BON</th>
					<th style="border: 2px solid black; color: red;">N°FACTURE</th>
