        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionReglementVente();">Confirmer</button>
                      ...
                      <div class="card-body">
                       ...
                       <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addReglementMatiere1('update');">Modifier</button>
                          ...
                          echo ' <button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addReglementMatiere1(\'insert\');">Valider</button>'; } ?></div>
                        </div>
