                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                           ...
                           <textarea class="commentaire form-control" placeholder="Commantaire"></textarea>
                          </div>
						  
						    <div class="col-md-3">
                            <label>Solde initial</label>
                            <input type="text" class="form-control solde_initial"  onkeyup ="formatMillier('solde_initial');" placeholder="Solde Initial">
                         ...
                         <div class="col-md-3">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_initial" data-target="#reservationdate" placeholder="date effet" value="<?php echo date('Y-m-d'); ?>"/>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addFournisseurMatiere('update');">Modifier</button>
                          </div>
                          <div class="col-md-4 alertSucces">
                           
                          </div>
                          <div class="col-md-4"><br> <button type="button" class=" btn-primary btn-lg btnAnnulerModif" style="display: none;" onclick="annulerModifClient1();">Annuler</button> 
                            <?php
                            if ($this->session->userdata('mira_sa_ajout')=="true") {
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addFournisseurMatiere(\'insert\');">Valider</button>'; } ?></div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionFournisseurMatiere();">Confirmer</button>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: FOURNISSEURS PRODUIT DE CARRIERE'
            },
            {
            extend: "pdf",
