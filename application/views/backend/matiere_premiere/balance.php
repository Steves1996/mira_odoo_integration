      ...
      <div class="col-4 col-sm-4">
                    ...
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-danger">
                      <div class="card-header">
                        <h3 class="card-title">Sélectionnez un fournisseurs</h3>
                      </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <select class="id_fournisseur form-control" onchange="getBalanceMatiere();">
                             <option value=""></option>
                     ...
                     <div class="card card-warning">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">          
                            Factures : <input type="text" disabled="true" class="totalFacture1 form-control" name="">
                            Règlement : <input type="text" disabled="true"  class="totalReglement1 form-control" name="">
          ...
          <div class="col-4 col-sm-4">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <input type="text" disabled="true" name="" class="solde1 form-control">
                          </div>
                          </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceMatiere();"/>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceMatiere();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
            ...
            <div class="col-12 col-sm-6" >
              <h3 style="text-align: center;">FACTURES</h3>
                     <hr>
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
