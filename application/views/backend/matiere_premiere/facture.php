                      ...
                      <div class="card-body">
                        <div class="row">
						 ...
						 <div class="col-md-3">
                            ...
                            <select class="facture form-control" onchange="getFournisseur();">
                             <option value=""></option>
                              <?php $this->crud_model_matiere->leSelectNumeroFacture(); ?>
                          ...
                          <div class="col-md-3">
                           ...
                           <input type="text" class="form-control id_fournisseur" placeholder="Fournisseur" disabled="true">
                          </div>
                          </div>
                       ...
                       <div class="col-md-3">
						    ...
						    <div class="col-md-3">
                           <label>Montant</label>
                            <input type="text" class="form-control montant"  placeholder=" en FCFA" onkeypress="chiffres(event);" disabled="true" onkeyup ="formatMillier('montant');" value = "0">
                       ...
                       <br>
                        ...
                        <?php
                            if ($this->session->userdata('SUPERVISEUR_ajout')=="true") {
                          echo '<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addFactureMatiere(\'insert\');">Valider</button>'; } ?></div>
                        </div>
            ...
            <div class="col-12 col-sm-12" style="overflow: auto;">
              <h3 style="text-align: center;">VISUALISATION</h3>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                 ...
                 <?php
                 $this->crud_model_matiere->selectAllFacture();
                  ?>
                  </tbody></table>
                    </div>
                        </div>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: FACTURE PRODUIT DE CARRIERE'
            },
            {
            extend: "pdf",
