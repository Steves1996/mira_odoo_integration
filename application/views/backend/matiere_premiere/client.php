                    ...
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control montantInitialisation" onkeypress="chiffres(event);" placeholder="Montant Initial" onkeyup ="formatMillier('montantInitialisation');">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4"><br> 
                            ...
                            <button type="button" class=" btn-primary btn-lg btnAnnulerModif" style="display: none;" onclick="annulerModifClient();">Annuler</button>
                            <?php
                            if ($this->session->userdata('client_ajout')=="true") {
                              # code...
                             echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addClient(\'insert\');">Valider</button>';
                            }?>
                          </div>
                        </div>
