...
?>
  ...
  <div class="content-wrapper" style="background: rgb(2,2,8) url(<?php echo base_url(); ?>assets/image/cimenterie4.jpg) no-repeat; background-size: cover;">
    ...
    <section class="content">
     ...
     <div class="row">
        ...
        <!-- /.modal-dialog -->
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent" style="width: 1000px;">
                 ...
                 <?php
                 $this->crud_model_pont_bascule->selectAllUtilisateur();
                  ?>
                  </tbody></table>
                    </div>
                        </div>
