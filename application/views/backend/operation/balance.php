                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <select class="id_fournisseur id_operation form-control" onchange="getBalancePourOperation();getClientOperation();getProduitOperation();getDateCreationOperation();">
                          ...
                          <div class="col-md-12 initial">
                            ...
                            <div class="form-group">
                            <label>Client</label>
                            <input type="text" class="form-control client" disabled="true" name="">
                          </div>
                          <div class="form-group">
                            <label>Produit</label>
                            <div class="input-group " id="" data-target-input="nearest" >
                              
                                <input type="text" class="form-control produit" data-target="#reservationdate" disabled="true" />
                               
                          </div>
                          </div>
                          <div class="form-group">
                            <label>Date création</label>
                            <input type="text" class="form-control dateCreation" disabled="true" name="">
                          </div>
                          </div>
                          </div>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">VENTE DES PIECES</h3>
                        <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i>
                        </button>
                      </div>
