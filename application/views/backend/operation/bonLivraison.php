                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                           ...
                           <div class="col-md-3">
                            ...
                            <select class="operation form-control">
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <label>Arrivée</label>
                            <input type="text" class="form-control arrivee" placeholder="Arrivée">
                          ...
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control PU" placeholder="en FCFA" onkeypress="chiffres(event); " onkeyup="getMontantTotal(); formatMillier('PU');" >
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addLivraison('update');">Modifier</button>
                          </div>
                          <div class="col-md-4 alertSucces">
                           <br> 
                          <button type="button" class=" btn-primary btn-lg btnAnnuler" style="display: none;" onclick="annuleModifLivraison();">Annuler</button> 
                        <?php
