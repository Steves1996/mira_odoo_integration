...
<div class="modal fade" id="modal-primary">
     ...
     <div class="row">
          ...
          <div class="col-4 col-sm-4">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <input type="text" disabled="true" name="" class="solde form-control" value="<?php $this->crud_model_caisse->getSoldeCaisse(); ?>">

                            <input type="hidden" disabled="true" name="" class="solde2 form-control" value="<?php $this->crud_model_caisse->getSoldeCaisse(); ?>">
                          </div>
                          </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceCaisse2();"/>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceCaisse2();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
            ...
            <div class="col-12 col-sm-6" >
              <h3 style="text-align: center;">ENTREES</h3>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                 ...
                 <?php
                 // $this->crud_model_caisse->selectAllEntreePourBalance();
                  ?>
                  </tbody></table>
                    </div>
                        </div>
            ...
            <div class="col-12 col-sm-6" >
              <h3 style="text-align: center;">SORTIES</h3>
                     <hr>
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                 ...
                 <?php
                 // $this->crud_model_caisse->selectAllSortiePourBalance();
                  ?>
                  </tbody>
                </table>
                    </div>
