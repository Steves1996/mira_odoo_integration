                    ...
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addFournisseurCaisse('update');">Modifier</button>
                          </div>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addFournisseurCaisse(\'insert\');">Valider</button>'; } ?></div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionFournisseurCaisse();">Confirmer</button>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: FOURNISSEURS CAISSE'
            },
            {
            extend: "pdf",
