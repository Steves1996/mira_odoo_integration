                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <textarea class="form-control commentaire" placeholder="commentaires"></textarea>
                          </div>
                        </div>

                        <div class="row">
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addCaisse('update');">Modifier</button>
                          </div>
                        ...
                        <?php
                          ...
                          echo ' <button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addCaisse(\'insert\');">Valider</button>'; } ?></div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionEntreeSortie();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">Liste des Type pour entrées et sorties</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: TYPES ENTREES ET SORTIES CAISSE'
            },
            {
            extend: "pdf",
