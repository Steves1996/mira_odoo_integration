        ...
        <!-- Small boxes (Stat box) -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3 id="target"><?php echo number_format($this->crud_model_caisse->getMontantEntreeCaisse(),0,',',' ').' FCFA'; ?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3 id="target2"><?php echo number_format($this->crud_model_caisse->getMontantSortieCaisse(),0,',',' ').' FCFA'; ?><sup style="font-size: 20px">%</sup></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3 id="target3"><?php $this->crud_model_caisse->getSoldeCaisse(); ?></h3>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_cloture" data-target="#reservationdate" placeholder="date effet" onchange="totauxPourCloture();" />
                          ...
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control entree"  placeholder="Total Entrée" disabled="true">
                            
                        
                          </div>
                          <div class="col-md-3">
                            <label>Total Sortie</label>
                            <input type="text" class="form-control sortie" placeholder=" Total Sortie" disabled="true">

                          </div>
                          <div class="col-md-3">
                            <label>Solde</label>
                            <input type="text" class="form-control solde" placeholder="Solde" disabled="true">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            ...
                            <input type="text" class="form-control ordonateur" placeholder="">

                          </div>
                          <div class="col-md-4"> 
                            <label></label>
                            <div class="custom-control custom-checkbox">
                          <input class="custom-control-input cloturer" type="checkbox" id="customCheckbox2" checked="">
                          <label for="customCheckbox2" class="custom-control-label">Cloture</label>
                        </div>
                          </div>
                          <div class="col-md-4">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input ancienne_date" data-target="#reservationdate" placeholder="date effet" />
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addClotureCaisse('update');">Modifier</button>
                          </div>
                          <div class="col-md-4 alertSucces">
                           <br> <button type="button" class=" btn-primary btn-lg btnAnnuler" style="display: none;" onclick="annulerModifLivraison();">Annuler</button> 
                           <?php
                            if ($this->session->userdata('caisse_ajout')=="true") {
                          echo '<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addClotureCaisse(\'insert\');">Valider</button>'; } ?>
                          </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionClotureCaisse();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">Historique des cloture</h3>
                  ...
                  <tr >
                    ...
                    <th>Date</th>
                    <th>Total entrée (FCFA)</th>
                    <th>Total Sortie (FCFA)</th>
                    <th>Solde (FCFA)</th>
                    <th>Ordonateur</th>
                    <!-- <th>Option</th> -->
                  </tr>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: CLOTURES CAISSE'
            },
            {
            extend: "pdf",
