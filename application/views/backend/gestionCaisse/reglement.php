...
<head>
  ...
  $reglementCaisse="";
  $ouvertFournisseurCaisse="";
  $activeFournisseurCaisse="";
  ?></title>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionReglementFournisseurCaisse();">Confirmer</button>
                  ...
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            ...
                            <select class="id_gazoil form-control" >
                             <option value="0"></option>
                              <?php $this->crud_model_caisse->leSelectFournisseurCaisse(); ?>
                          ...
                          <div class="col-md-3">
                             <label>numéro</label>
                            <input type="text" class="form-control numero" placeholder="En chiffre">
                       ...
                       <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addReglementCaisse('update');">Modifier</button>
                      ...
                      <?php
                            if ($this->session->userdata('fournisseur_caisse_ajout')=="true") {
                          echo ' <button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addReglementCaisse(\'insert\');">Valider</button>'; } ?></div>
                        </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getReglementParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getReglementParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
						...
						<div class="col-md-4">
                            <div class="form-group">
                            <label>Fournisseur</label>
                            <select class="id_fournisseur1 form-control" onchange="getReglementParDate();"/>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: REGLEMENT CAISSE'
            },
            {
            extend: "pdf",
