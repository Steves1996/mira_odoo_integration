                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange=" getAllDemandeCaisseRetour();" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getAllDemandeCaisseRetour();" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <select class="validite1 form-control" autocomplete='on' onchange ="getAllDemandeCaisseRetour();">
                             <option value=""></option>
               ...
               <div class="tab-content" id="custom-tabs-one-tabContent">
                  ...
                  <tr style=" margin: 0px;">
                    <td onclick="" colspan="2" style=" margin: 0px;border: none; border-bottom: 2px solid black; ">
                          ...
                          <span style="font-size: 25px; border: none; font-weight: bold;">RETOUR EN CAISSE</span><br/>
                ...
                <!--   <tr style="padding: 0; margin: 0px;">
                  ...
                  <tr style="margin: 0px; padding: 0px; border: none;">
                    ...
                    <td colspan="8" style="margin: 0px; padding: 0px;border: none;"></td>  
                  </tr>
				  
                  <tr>
                    <td style="margin: 0px; padding: 0px;border: none;">Demandé le :</td> 
                    <td   class="date_commande2" style="margin: 0px; padding: 0px;border: none;">...</td> 
                  ...
                  <tr>
                    <td style="margin: 0px; padding: 0px;border: none;">Ordonnateur :</td> 
                    <td class="fournisseur" style="margin: 0px; padding: 0px;border: none;">...</td> 
                    <td colspan="6" style="margin: 0px; padding: 0px;border: none;"></td>
                    <td style="margin: 0px; padding: 0px;border: none;width: 18%" colspan="1">Etat de la demande:</td> 
                    <td class="etat_expedition2" style="margin: 0px; padding: 0px;border: none;"></td>  

                  </tr>
				  
                  <tr>
                    <td style="margin: 0px; padding: 0px;border: none; border: none; ">Numéro :</td> 
                    <td class="po2" style="margin: 0px; padding: 0px;border: none; border: none; width: 10% ">...</td> 
                    <td colspan="6" style="margin: 0px; padding: 0px;border: none;border: none; width: 10%"></td> 
                    <td style="margin: 0px; padding: 0px;border: none; border: none;width: 10%" colspan="1">Etat de la demande:</td> 
                    <td  class="etat_expedition2" style="margin: 0px; padding: 0px; border: none; width: 10%"></td> 
                  </tr>
                 ...
                 <!--  <td style="border-bottom: : 1px solid black;width: 10%; text-align: center;border-bottom: 3px solid black; ">PO(item)</td>
                    ...
                    <td style="border-left: 1px solid white;width: 10%; text-align: center;border-bottom: 3px solid black; ">Numero</td>
                    <td style="border-left: 1px solid white;width: 10%; text-align: center;border-bottom: 3px solid black; ">Type Sortie</td>
					
                    <td style="border-left: 1px solid white;width: 10%; text-align: center;border-bottom: 3px solid black; ">Véhicule</td>
					<td style="border-left: 1px solid white;width: 10%; text-align: center;border-bottom: 3px solid black; ">Opération</td>
                    <td style="border-left: 1px solid white;width: 10%; text-align: center;border-bottom: 3px solid black; ">Fournisseur</td>
					<td style="border-left: 1px solid white;width: 10%; text-align: center;border-bottom: 3px solid black; ">Destination</td>
					<td style="border-left: 1px solid white;width: 10%; text-align: center;border-bottom: 3px solid black; ">Montant</td>
					<td colspan = "3" style="border-left: 1px solid white;width: 10%; text-align: center;border-bottom: 3px solid black; ">Justification</td>
