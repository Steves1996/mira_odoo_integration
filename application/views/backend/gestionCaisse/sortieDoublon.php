...
<div class="modal fade" id="modal-primary">
     ...
     <div class="row">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet" value  = "<?php echo date('Y-m-d'); ?>"  onchange="getSortieParDate1();"/>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet" value  = "<?php echo date('Y-m-d'); ?>"  onchange="getSortieParDate1();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <select class="validite1 form-control" autocomplete='on' onchange ="getSortieParDate1();">
            ...
            <div class="col-12 col-sm-12" style="overflow: auto;">
              <h3 style="text-align: center;">VISUALISATION DOUBLONS</h3>
                     <hr>
