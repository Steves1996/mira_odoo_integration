        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionEntree();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;">ENREGISTREMENT DES ENTREES</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <div class="col-md-3">
                          <div class="form-group">
                              <label>Type</label>
                              <select class="camion form-control" onchange ="getfournisseur1();" >
                                <?php $this->crud_model_caisse->leSelectCaisseEntree(); ?>
                                </select>
                            </div>
						     ...
						     <div class="col-md-3">
						  <div class="form-group">
						  <label>Type Entrée Caisse</label>
                            
                        
                          <select class="validite form-control" autocomplete='on' onchange ="getfournisseur();" disabled = "true">
						 ...
						 <div class="form-group">
						  ...
						  <div class="col-md-3">
                            ...
                            <select class="operation form-control" autocomplete='on' disabled="true" onchange="">
                              ...
                              <?php $this->crud_model_caisse->leSelectOperation(); ?>
                   ...
                   <!--       
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addEntree('update');">Modifier</button>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addEntree(\'insert\');">Valider</button>'; } ?>
                          </div>
                        </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getEntreeParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getEntreeParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
						   ...
						   <div class="col-md-3">
						  <div class="form-group">
						  <label>Type Entree Caisse</label>
                            
                        
                          <select class="validite1 form-control" autocomplete='on' onchange ="getEntreeParDate();">
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Liste des entrées</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: ENTREES CAISSE'
            },
            {
            extend: "pdf",
