                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            Entrées: <input type="text" disabled="true" class="totalEntree form-control" name="" value="<?php echo number_format($this->crud_model_caisse->getMontantEntreeCaisseParJour(),0,',',' ').' FCFA'; ?>">
                          
						 <!--     Entrées: <input type="text" disabled="true" class="totalEntree form-control" name="" value="<?php echo number_format($this->crud_model_caisse->getMontantEntreeCaisse(),0,',',' ').' FCFA'; ?>">
...
-->
							...
							Sorties : <input type="text" disabled="true"  class="totalSortie form-control" name="" value="<?php echo number_format($this->crud_model_caisse->getMontantSortieCaisseParJourNew(),0,',',' ').' FCFA'; ?>">
                      

						 <!--   Sorties : <input type="text" disabled="true"  class="totalSortie form-control" name="" value="<?php echo number_format($this->crud_model_caisse->getMontantSortieCaisse(),0,',',' ').' FCFA'; ?>">
...
-->
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <input type="text" disabled="true" name="" class="solde form-control" value="<?php echo number_format($this->crud_model_caisse->getSoldeCaisseNew(),0,',',' ').' FCFA'; ?>">

                       <!--      <input type="hidden" disabled="true" name="" class="solde2 form-control" value="<?php echo number_format($this->crud_model_caisse->getSoldeCaisseNew(),0,',',' ').' FCFA'; ?>"> -->
                          </div>
                          </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceImprimableCaisse();" />
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceImprimableCaisse();" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
						  ...
						  <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <select class="lieu form-control" onchange="getBalanceImprimableCaisse();">
        ...
        <!-- /.modal-dialog -->
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">RELEVE COMPTE CAISSE</h3>
                ...
                <table id="example7" class="table tab2 table-bordered" style="border: none;" cellpadding="0" cellspacing="0">
                  <thead>
                      <tr><td colspan="5" style="text-align: center;"> <span style="font-size: 25px; border: none; font-weight: bold; text-align: center;">RELEVE COMPTE CAISSE </span> <span style="font-size: 23px; border: none; font-weight: bold;" class="client"></span></td>
                   </tr>
                  <tr style=" margin: 0px;">
 ...
 -->                      <span style="font-size: 13px; border: none; font-weight: bold;" >VILLE : DOUALA </span>
                      <br/>
                      <span style="font-size: 13px; border: none; font-weight: bold;" >ADRESSE : MIRA TRANSPORT</span>
                     <br/>
                      <span style="font-size: 13px; border: none; font-weight: bold;" >Téléphone : 679091919</span>
