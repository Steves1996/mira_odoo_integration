                  ...
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control identifiant" placeholder="Identifiant">
                          ...
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control commentaire" placeholder="commentaire">

                          </div>
                         
                        </div>
                        <h2 style="text-align: center;">Privilèves</h2>
                            <br>

                        <div class="row contentPrivilege">
                       
                        <?php 
                        include 'assets/include_privilege.php';
                        ?>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addUser('update');">Modifier le Privilège</button>
                            <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addUser('update1');">Modifier le Profil</button>
                          </div>
                      ...
                      <?php
                            if ($this->session->userdata('users_ajout')=="true") {
                          echo ' <button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addUser(\'insert\');">Valider</button>'; } ?></div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionProfile();">Confirmer</button>
...
<script src="<?php echo base_url(); ?>assets/js/admin_profile.js"></script>
<script>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: UTILISATEURS'
            },
            {
            extend: "pdf",
