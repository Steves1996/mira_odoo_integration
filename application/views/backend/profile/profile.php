     ...
     <div class="row">
      <div class="col-2 col-sm-2">
          ...
          <div class="col-6 col-sm-6">
                    ...
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                            <input type="text" class="form-control identifiant" placeholder="Identifiant" value="<?php echo $this->session->userdata('identifiant'); ?>">
                        ...
                        <?php
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="modifProfile();">Valider</button>';  ?></div>
                        </div>
               ...
               <input type="hidden" class="id_client" name="" value="<?php echo $this->session->userdata('id_profil'); ?>">
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: PROFILES'
            },
            {
            extend: "pdf",
