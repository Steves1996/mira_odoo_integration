                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                            ...
                            <label>Code vraquier</label>
                            <select class="code_camion form-control camion" onchange=" getDestinationParCodeCamion();">
                                <?php $this->crud_model_vehicule->leSelectVraquier(); ?>
                                </select>
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <label>TVA</label>
                              <select class="tva form-control" onchange="getPrixAvecTVALocationEngin();">
                          ...
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control PU1" placeholder="en FCFA" onkeypress="chiffres(event); " onkeyup="  getPrixAvecTVALocationEngin()" >

                          </div>
                          <div class="col-md-3">
                            <label>Nouveau prix unitaire</label>
                            <input type="text" class="form-control montant PU" placeholder="Prix unitaire" onkeyup="getMontantTotal();" disabled="true">

                          </div>
                          <div class="col-md-3">
                            <label>Durée (heure/jour) </label>
                            <input type="text" class="form-control duree quantite" placeholder="choisir l'unité"  onkeypress="chiffres(event);" onkeyup="getMontantTotal();">
                            <select class="unite form-control">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_location" data-target="#reservationdate" placeholder="date effet" />
                       ...
                       <!--  </div>
                        <div class="row"> -->
                          ...
                          <div class="col-md-3">
                            ...
                            <select class="arrivee form-control destinationRoute">
                           ...
                           <div class="col-md-3">
                            ...
                            <select class="operation form-control" onchange="getDescriptionOperation(); getClientOperation();">
                             <option value=""></option>
                              <?php $this->crud_model_depense->leSelectOperation(); ?>
                                
                              </select>
                          </div>
                            <br>  <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addLocationVraquier('update');">Modifier</button>
                          </div>
                          <div class="col-md-3">
                            <label>Client</label>
                          ...
                          <div class="col-md-3 alertSucces">
                            <div class="form-group">
                              <label>Destination (Opération)</label>
                          ...
                          <div class="col-md-3">
                            <label>Total</label>
                            <input type="text" class="form-control total PT" placeholder="total" disabled="true">
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-3"></div>
                         <div class="col-md-3"></div>
                          <div class="col-md-3"><br> <button type="button" class=" btn-primary btn-lg btnAnnulerModif" style="display: none;" onclick="annulerModifClient();">Annuler</button> 
                            <?php
                            if ($this->session->userdata('recette_ajout')=="true") {
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addLocationVraquier(\'insert\');">Valider</button>'; } ?></div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionLocationVraquier();">Confirmer</button>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: LOCATION ENGIN'
            },
            {
            extend: "pdf",
