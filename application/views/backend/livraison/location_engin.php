                        ...
                        <div class="row">
                          <div class="col-md-3">
                            ...
                            <select class="code_camion form-control camion" onchange=" getDestinationParCodeCamion();">
                                <?php $this->crud_model_vehicule->leSelectEngin(); ?>
                                </select>
                       ...
                       <!--  </div>
                        <div class="row"> -->
                          ...
                          <div class="col-md-3">
                           ...
                           <div class="col-md-3">
                            ...
                            <br>  <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addLocationEngin('update');">Modifier</button>
                          </div>
                          <div class="col-md-3">
                            <label>Client</label>
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-3"></div>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addLocationEngin(\'insert\');">Valider</button>'; } ?></div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionLocationEngin();">Confirmer</button>
