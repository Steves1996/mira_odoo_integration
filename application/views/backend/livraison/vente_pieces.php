                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <label>Pièce: </label>
                            <input type="text" class="form-control piece" placeholder="Montant" >

                          </div>
                          <div class="col-md-3">
                            <label>Montant: </label>
                            <input type="text" class="form-control montant" placeholder="Montant" onkeypress="chiffres(event);" onkeyup ="formatMillier('montant');">
                          ...
                          <div class="col-md-3">
                            ...
                            <label>Date: </label>
                              <div class="input-group " id="" data-target-input="nearest" >
                                    ...
                                    <input type="date" class="form-control datetimepicker-input date_piece" data-target="#reservationdate" placeholder="date effet" />
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                            <label>CLIENT</label>
                            <select class="leClient form-control" >
                             <option value="0"></option>
                              <?php $this->crud_model_client->leSelectClient(); ?>
                          ...
                          <div class="col-md-3">
                            <label>Libellé</label>
                            <input type="text" placeholder="libellé" class="libelle form-control" name="">
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                            ...
                            <br>   <button type="button" class=" btn-primary btn-lg btnAnnulerModif" style="display: none;" onclick="annulerModifClient1();">Annuler</button>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addVentePieces('update');">Modifier</button>
                          <?php
                            if ($this->session->userdata('recette_ajout')=="true") {
                          echo ' <button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addVentePieces(\'insert\');">Valider</button>'; } ?></div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionVentePiece();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">Liste des pieces vendues</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: CHARGERMENT RETOUR'
            },
            {
            extend: "pdf",
