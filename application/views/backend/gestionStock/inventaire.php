                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <label>Auteur :</label>
                            <input type="text" class="form-control auteur" value="LA DIRECTION" placeholder="Auteur">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="$('#example1').DataTable().destroy(); selectAllInventaire('#example1');"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="$('#example1').DataTable().destroy(); selectAllInventaire('#example1');"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                           ...
                           <div class="form-group">
                            <label>Fournisseur :</label>
                            <select class="id_fournisseur1 form-control" onchange="$('#example1').DataTable().destroy(); selectAllInventaire('#example1');">
