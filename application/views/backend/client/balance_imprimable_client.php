      ...
      <div class="col-4 col-sm-4">
                    ...
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-danger">
                      <div class="card-header">
                        <h3 class="card-title">Sélectionnez un Client</h3>
                      </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <label>Client</label>
                            <select class="id_fournisseur form-control  articles" onchange="getBalanceImprimableClient1();">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceImprimableClient1();" value="<?php echo date('Y-m-d'); ?>"/>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceImprimableClient1();" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
        ...
        <!-- /.modal-dialog -->
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">RELEVE COMPTE CLIENT</h3>
                ...
                <table id="example7" class="table tab2 table-bordered" style="border: none;" cellpadding="0" cellspacing="0">
                  <thead>
                      <tr><td colspan="5" style="text-align: center;"> <span style="font-size: 25px; border: none; font-weight: bold; text-align: center;">RELEVE COMPTE CLIENT :</span> <span style="font-size: 23px; border: none; font-weight: bold;" class="client"></span></td>
                   </tr>
                  <tr style=" margin: 0px;">
