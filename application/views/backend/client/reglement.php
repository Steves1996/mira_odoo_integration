        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionReglementClient();">Confirmer</button>
                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            ...
                            <select class="id_gazoil form-control" >
                             <option value="0"></option>
                              <?php $this->crud_model_client->leSelectClientTransport(); ?>
                          ...
                          <div class="col-md-3">
                             <label>numéro</label>
                            <input type="text" class="form-control numero" placeholder="">
                       ...
                       <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addReglementClient('update');">Modifier</button>
                          ...
                          <div class="col-md-4"><br> <button type="button" class=" btn-primary btn-lg btnAnnuler" style="display: none;" onclick="annulerSuppressionGazoil();">Annuler</button>
                            <?php
                            if ($this->session->userdata('client_ajout')=="true") {
                          echo '<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addReglementClient(\'insert\');">Valider</button>';
                         }?></div>
                        </div>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: LISTE DES REGLEMENTS CLIENT'
            },
            {
            extend: "pdf",
