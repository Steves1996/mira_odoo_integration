                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <select class="categorie form-control">
                                <?php $this->crud_model_article->leSelectCategorie(); ?>
                                </select>
                            </div>
                            <!-- <label>Numéro</label> -->
                            <input type="hidden" class="form-control numero" value="annulé" placeholder="Numéro">
                          ...
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control PU" placeholder="" onkeyup ="formatMillier('PU');">

                          </div>
                          <div class="col-md-3">
                            <label>Seuil commande</label>
                            <input type="text" class="form-control seuilCommande" placeholder="">
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control codeBarre" placeholder="">

                          </div>
                          <div class="col-md-3">
                            <label>Fournisseur</label>
                            <input type="text" class="form-control fournisseur" placeholder="">

                          </div>
                          <div class="col-md-3">
                            <label>Manufacturier</label>
                            <input type="text" class="form-control manufacturier" placeholder="">
						  ...
						  <div class="col-md-3">
                            ...
                            <select class="id_fournisseur1 form-control" >
                              ...
                              <?php $this->crud_model_depense->leSelectTypePneu(); ?>
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <!-- <label>Référence</label>
                            <input type="text" class="form-control reference" placeholder=""> -->
                          </div>
                          <div class="col-md-3"></div>
                          <div class="col-md-3">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addArticle('update');">Modifier</button>
                          </div>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addArticle(\'insert\');">Valider</button>'; }
                          ?>
                          </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionArticle();">Confirmer</button>
