                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;">ENREGISTREMENT DES INVENTAIRES</h3>
                     <hr>
                      ...
                      <div class="card-body">
						...
						<div class="col-md-12">
                            ...
                            <select class="id_fournisseur form-control" >
                              ...
                              <?php $this->crud_model_depense->leSelectFournisseurHuile(); ?>
                        ...
                        <div class="form-group">
                            <label>Coisir une catégorie</label>
                            <select class="categorie form-control" onchange="getArticleParCategorie();">
                             
                              <?php $this->crud_model_article->leSelectCategorie(); ?>
                       ...
                       <!--  <div class="row">
                          ...
                          <div class="col-md-4"><br> <button type="button" class=" btn-primary btn-lg btnAnnulerModif" style="display: none;" onclick="annulerModifClient();">Annuler</button> <button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addClient('insert');">Valider</button></div>
                        </div> -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionInventaireGazoil();">Confirmer</button>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="$('#example1').DataTable().destroy(); selectAllInventaireHuile('#example1');"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="$('#example1').DataTable().destroy(); selectAllInventaireHuile('#example1');"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">Liste des inventaires Huiles</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: INVENTAIRES'
            },
            {
            extend: "pdf",
