        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionVidangeGraisse();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;">ENREGISTREMENT DES GRAISSES</h3>
                     <hr>
                     <div class="card card-info">
                        ...
                        <div class="row">
						 ...
						 <div class="col-md-2">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input datePrime" data-target="#reservationdate" placeholder="date effet" onchange="" />
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
						     ...
						     <div class="col-md-1">
                            <label>Graisse</label>
                            <select class="huile form-control id_type" onload="getPrixUnitaireGraisse();" onchange="getPrixUnitaireGraisse();getStockGraisseV();">
                                <?php $this->crud_model_depense->getGraisseVidange(); ?>
                                </select>
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addVidangeGraisse('update');">Modifier</button>
                        
                           </div>
                 
                          <div class="col-md-3"><br> <button type="button" class=" btn-primary btn-lg btnAnnuler" style="display: none;" onclick="annulerSuppressionGazoil();">Annuler</button>
                          <?php
                            if ($this->session->userdata('vidange_ajout')=="true") {
                           echo' <button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addVidangeGraisse(\'insert\');">Valider</button>';} ?></div>
                        </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getVidangeGraisseParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getVidangeHydroliqueParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Liste des vidanges hydrolique</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: LISTE DES VIDANGES HYDROLIQUES'
            },
            {
            extend: "pdf",
