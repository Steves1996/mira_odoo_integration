        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionDepenseChauffeur();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;">ENREGISTREMENT DES PRIMES</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                            <label>Dernier jour du mois : </label>
                          <div class="input-group " id="" data-target-input="nearest" >
                              
                                <input type="date" class="form-control datetimepicker-input date" data-target="#reservationdate" placeholder="date effet" onchange="getExpirationPneu();" />
                      ...
                      <div class="col-md-3">
                          <div class="form-group">
                              ...
                              <select class="camion form-control code_camion">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <select class="chauffeur form-control id_chauffeurs" onchange="getAssistantChauffeur();">
                              <?php $this->crud_model_chauffeur->leSelectChauffeur2(); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control assistant" placeholder="" onkeypress="" disabled="true">

                          </div>
                          <div class="col-md-3">
                            <label>Montant net Chauffeur</label>
                            <input type="text" class="form-control montantNetChauffeur" placeholder=" en FCFA" onkeypress="chiffres(event);" onkeyup ="formatMillier('montant');" disabled="true">

                          </div>
                          
                          <div class="col-md-3">
                            <label>Montant net Assistant</label>
                            <input type="text" class="form-control montantNetAssistant" placeholder=" " onkeypress="" disabled="true">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                              <label>TOTAL</label>
                              <input type="text" class="form-control totalMontantNet" placeholder=" " onkeypress="" disabled="true">
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addDepenseSalaireChauffeur('update');">Modifier</button>
                        ...
                        <?php
                            if ($this->session->userdata('depense_ajout')=="true") {
                           echo'<button type="button" class=" btn-primary btn-lg btnAdd"  onclick=" addDepenseSalaireChauffeur(\'insert\');">Valider</button>'; ?>
                         </div>
                         <div class="col-md-3">
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Liste des primes</h3>
                  ...
                  <tr >
                    ...
                    <th>Code camion</th>
                    <th>Date</th>
                    <th>Salaire net Chauffeur</th>
                    <th>Salaire net Assistant</th>
                    <th>Total</th>
                    <th>Action</th>
                  </tr>
                  </thead>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: LISTE DES DEPENSES PRIME'
            },
            {
            extend: "pdf",
