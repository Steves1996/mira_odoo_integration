     ...
     <div class="row">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                <input type="hidden" class="form-control datetimepicker-input date_dernier_inv" data-target="#reservationdate" placeholder="date effet" value="<?php echo $this->crud_model_depense->getDateDernierInventaireGazoil(); ?>" />

                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet" onchange="compareDateInventaire();" value="<?php echo $this->crud_model_depense->getDateDernierInventaireGazoil(); ?>" />
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet" onchange="rechercheStockParDate();" />
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
						...
						<div class="col-md-6">
                           <div class="form-group">
                            ...
                            <select class="id_fournisseur1 form-control" onchange="$('#example10').DataTable().destroy(); rechercheStockParDate('#example10');">
        ...
        <!-- /.modal-dialog -->
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                 ...
                 <?php
                 $this->crud_model_depense->stockGazoil();
                  ?>
                  </tbody></table>
                    </div>
                        </div>
