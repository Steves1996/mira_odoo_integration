        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionVidangeHydrolique();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;">ENREGISTREMENT DES VIDANGES HYDROLIQUE</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
						     ...
						     <div class="col-md-1">
                            <label>Huile</label>
                            <select class="huile form-control id_type" onload="getPrixUnitaireHuile();" onchange="getPrixUnitaireHuile();getStockHuileH();">
                                <?php $this->crud_model_depense->getHuileHydrolique(); ?>
                                </select>
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addVidangeHydrolique('update');">Modifier</button>
                          ...
                          <?php
                           ...
                           echo' <button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addVidangeHydrolique(\'insert\');">Valider</button>';} ?></div>
                        </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getVidangeHydroliqueParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
