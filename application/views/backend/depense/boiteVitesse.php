        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionVidangeBoite();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;">ENREGISTREMENT DES VIDANGES DE LA BOITE DE VITESSE</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <div class="col-md-2">
						 ...
						 <label>Date : </label>
                          ...
                          <div class="col-md-2">
                            <label>Huile</label>
                            <select class="huile form-control id_type" onload="getPrixUnitaireHuile();" onchange="getPrixUnitaireHuile();getStockHuileB();">
                                <?php $this->crud_model_depense->getHuileBoite(); ?>
                                </select>
						...
						<!-- compareQte(); -->
						   ...
						   <div class="col-md-2">
                            ...
                            <input type="text" name="" placeholder="quantité en littre" class="stock form-control" onkeypress="chiffres(event);" onkeyup="getPrixTotalVidange(); getStockHuileB();" disabled="true" value = "0">
                          </div>
                          </div>
						  ...
						  <div class="col-md-1 alertSucces">
                            <div class="form-group">
                              <label>Prix unitaire</label>
                               <input type="text" name="" placeholder="" class="PU form-control">
                            </div>
                           </div>
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addVidangeBoite('update');">Modifier</button>
                          ...
                          <div class="col-md-3"><br> <button type="button" class=" btn-primary btn-lg btnAnnuler" style="display: none;" onclick="annulerSuppressionGazoil();">Annuler</button>
                           ...
                           echo'<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addVidangeBoite(\'insert\');">Valider</button>';}
                           ?></div>
                        </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getVidangeBoiteParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getVidangeBoiteParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Liste des vidanges de la boite de vitesse</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: VIDANGE BOITE DE VITESSE'
            },
            {
            extend: "pdf",
