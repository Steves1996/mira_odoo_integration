...
<div class="modal fade" id="modal-primary">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionPieceRechange();">Confirmer</button>
     ...
     <div class="row">
      <div class="col-12 col-sm-12">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;">ENREGISTREMENT DES PIECES DE RECHANGE</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
						   ...
						   <div class="col-md-3">
                            <label>Bon Sortie</label>
                            <input type="text" name="" placeholder="reference " class="bon_sortie form-control">
                          </div>
                      ...
                      <div class="col-md-3">
                          ...
                          <div class="col-md-1">
                            <div class="form-group">
                            <label>Origine</label>
                            <select class="origine form-control" onchange="getPrixUnitaireArticle();">
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                              <label>Article</label>
                              <select class="article form-control" onchange="getPrixUnitaireArticle();getReferenceArticle();getStockArticle(); ">
                                <option value=""></option>
								<!-- /.getStockArticle(); -->
								
                            	    <?php $this->crud_model_depense->leSelectArticleSortie(); ?>  
						...
						<!-- <?php $this->crud_model_depense->leSelectArticle(); ?>   -->
						   ...
						   <div class="col-md-2">
                            <label>Stock</label>
                            <input type="text" placeholder="Stock" name="" class="form-control stock" onkeypress="chiffres(event);" disabled="true" >
                          ...
                          <div class="col-md-2">
							...
							<!-- compareQte(); -->
                            <input type="text" placeholder="quantité" name="" class="form-control qtite" onkeypress="chiffres(event);" onkeyup="  getPrixTotalPourPieceRechange(); getPrixAvecTVAPieceRechange();">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <label>TVA</label>
                              <select class="tva tva1 form-control" onchange="getPrixAvecTVAPieceRechange();">
                          ...
                          <div class="col-md-2">
                            ...
                            <input type="text" name="" placeholder="Prix unitaire " class="PU form-control" onkeypress="chiffres(event); " onkeyup ="formatMillier('PU'); getPrixTotalPourPieceRechange(); getPrixAvecTVAPieceRechange();">
                          </div>
                          <div class="col-md-3">
                            <label>Nouveau Prix unitaire</label>
                            <input type="text" class="form-control PU1" placeholder="en FCFA" onkeypress="chiffres(event); " onkeyup="getMontantTotal(); formatMillier('PU1');" disabled="true">

                          </div>
						  
						    <div class="col-md-3">
                            <label>Prix Total</label>
                            <input type="text" name="" placeholder="Prix Total " class="PT form-control" disabled="true" onkeypress="chiffres(event);" onkeyup ="formatMillier('PT');">
                          </div>
						  
                          <div class="col-md-3">
                            <label>Référence</label>
                            <input type="text" name="" placeholder="reference " class="reference form-control">
                          </div>
                          ...
                          <div class="col-md-3">
                            ...
                            <select class="id_fournisseur form-control">
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addPieceRechange('update');">Modifier</button>
                          ...
                          <div class="col-md-4"><br> <button type="button" class=" btn-primary btn-lg btnAnnuler" style="display: none;" onclick="annulerSuppressionGazoil();">Annuler</button> 
                            <?php
                            if ($this->session->userdata('stock_ajout')=="true") {
                           echo'<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addPieceRechange(\'insert\');">Valider</button>'; }?></div>
                        </div>
               ...
               <input type="hidden" class="compteur" name="">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getPieceRechangeParDate(); " value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getPieceRechangeParDate(); " value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                       ...
                       <div class="form-group">
                       <label>Article</label>
                        <select class="articles1 form-control" autocomplete='on' onchange="getPieceRechangeParDate(); ">
                         <option value=""></option>
                       <?php $this->crud_model_depense->leSelectArticle(); ?>
                       </select></div>
                       </div>
                       ...
                       <div class="form-group">
                       <label>Opération</label>
                        <select class="articles2 form-control" autocomplete='on' onchange="getPieceRechangeParDate(); ">
                         <option value=""></option>
                       <?php $this->crud_model_depense->leSelectOperation(); ?>
                       </select></div>
                       </div>
                       ...
                       <div class="form-group">
                       <label>Véhicule</label>
                        <select class="camion1 form-control" autocomplete='on' onchange="getPieceRechangeParDate(); ">
                         <option value=""></option>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Pièces de rechange</h3>
                     ...
                     <div class="overlay-wrapper" style="">
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        <input type="hidden" class="tabArticle" name="">
                  <thead>
                  <tr >
                    <th></th>
                    <th onclick="">N°</th>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: LISTE DES PIECES DE RECHANGE'
            },
            {
            extend: "pdf",
