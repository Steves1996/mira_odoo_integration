        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionVidange();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;">ENREGISTREMENT DES VIDANGES MOTEURS</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
                              ...
                              <select class="camion form-control" onchange ="getKilometrageVehicule();">
                          ...
                          <div class="col-md-2">
                            <label>Huile</label>
                            <select class="huile form-control id_type" onload="getPrixUnitaireHuile();" onchange="getPrixUnitaireHuile(); getPrixTotalVidange(); getStockHuile();">
                                <?php $this->crud_model_depense->getHuileMoteur(); ?>
                                </select>
						  ...
						  <div class="col-md-2">
                            ...
                            <input type="text" name="" placeholder="quantité en littre" class="stock form-control" onkeypress="chiffres(event); " onkeyup="getPrixTotalVidange();" disabled="true" value = "0">
                          </div>
                          </div>
						  ...
						  <div class="col-md-1">
                            ...
                            <input type="text" name="" placeholder="quantité en littre" class="qtite form-control" onkeypress="chiffres(event); " onkeyup="getPrixTotalVidange();compareQte();">
                          </div>
                          </div>
						  
						  <div class="col-md-1 alertSucces">
                            <div class="form-group">
                              <label>Prix unitaire</label>
                               <input type="text" name="" placeholder="quantité en littre" class="PU form-control">
                            </div>
                           ...
                           <div class="col-md-2">
                            <div class="form-group">
                              <label>Prix Total</label>
                               <input type="text" name="" placeholder="Prix total" class="PT form-control" disabled="true">
                            </div>
                          </div>
                        ...
                        <div class="row">
						  ...
						  <div class="col-md-2">
                            ...
                            <select class="id_fournisseur form-control" >
                              ...
                              <?php $this->crud_model_depense->leSelectFournisseurArticle(); ?>
                          ...
                          <div class="col-md-3">
                           ...
                           <div class="col-md-2 alertSucces">
                            <div class="form-group">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <label>Kilometrage vidange</label>
                               <input type="text" name="" placeholder="Kilometrage" class="kilometrage form-control" >
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <label>Kilometrage Gasoil</label>
                               <input type="text" name="" placeholder="Kilometrage Gasoil" class="KilometrageGasoil form-control" disabled="true" >
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3"><br>  <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addVidange('update');">Modifier</button>
                            <?php
                            if ($this->session->userdata('vidange_ajout')=="true") {
                           echo'<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addVidange(\'insert\');">Valider</button>';
                         }?>
                           </div>
                        </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getVidangeParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getVidangeParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Liste des vidanges</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: LISTE DES VIDANGES MOTEURS'
            },
            {
            extend: "pdf",
