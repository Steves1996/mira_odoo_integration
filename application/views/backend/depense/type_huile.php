                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;">ENREGISTREMENT DU TYPE D'HUILE</h3>
                     <hr>
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                            ...
                            <select class="type_huile form-control" onchange="">
                             <option value="moteur">Moteur</option>
                              <option value="boite">Boite de vitesse</option>
                          ...
                          <div class="col-md-3">
                            <label>Huile</label>
                            <input type="text" class="form-control huile" placeholder="Huile" >

                          </div>
                          <div class="col-md-3">
                            <label>Prix unitaire</label>
                            <input type="text" class="form-control PU" placeholder="prix unitaire" onkeypress="chiffres(event);">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addTypeHuile('update');">Modifier</button>
                          </div>
                          ...
                          <div class="col-md-4"><br> <button type="button" class=" btn-primary btn-lg btnAnnulerModif" style="display: none;" onclick="annulerModifClient();">Annuler</button>
                           ...
                           echo'<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addTypeHuile(\'insert\');">Valider</button>';} ?>
                          </div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionTypeHuile();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">Liste des type d'huile</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: LISTE DES TYPES D\'HUILE'
            },
            {
            extend: "pdf",
