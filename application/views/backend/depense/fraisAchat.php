        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionFraisAchat();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;">ENREGISTREMENT DES FACTURES ACHATS</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
						 ...
						 <div class="form-group">
                            ...
                            <input type="text" class="form-control numero" placeholder="Numero Lettre" >
						</div>
                        </div>
						 ...
						 <div class="form-group">
                            ...
                            <input type="text" class="form-control voyage" placeholder="Numero" value = "AUCUN" >
						</div>
                        </div>
						 ...
						 <div class="col-md-3">
                          <div class="form-group">
                              ...
                              <select class="fournisseur form-control" autocomplete='on' >
							   				
                              <?php $this->crud_model_matiere->leSelectFournisseurMatiere(); ?> 
                                </select>
                            </div>
                      ...
                      <div class="col-md-2">
                          ...
                          <select class="validite form-control" autocomplete='on' onchange ="">
                            <option value=" "></option>
							<option value="Pouzolane Noire">Pouzolane Noire</option>
                            <option value="Pouzolane Rouge">Pouzolane Rouge</option>
						  ...
						  <div class="col-md-2">
                            ...
                            <input type="text" class="form-control quantite" placeholder=" en FCFA" onkeypress="chiffres(event);" onkeyup ="getTotal(); formatMillier('quantite');" value = "0">

                          </div>

                          <div class="col-md-2">
                            <label>Montant</label>
                            <input type="text" class="form-control montant" placeholder=" en FCFA" onkeypress="chiffres(event);"  onkeyup ="getTotal(); formatMillier('montant'); " value = "0">

                          </div>
						  
						  <div class="col-md-2">
                           <label>Montant Total</label>
                            <input type="text" class="PT form-control montant1"  placeholder=" en FCFA" onkeypress="chiffres(event);"  onkeyup ="formatMillier('montant1');" value = "0">
                        ...
                        <div class="row">
						 ...
						 <div class="form-group">
                            ...
                            <input type="text" class="form-control facture" placeholder="Facture">
						</div>
                        </div>
                          ...
                          <div class="col-md-2 alertSucces">
                            ...
                            <div class="form-group">
                              ...
                              <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addFraisAchat('update');">Modifier</button>
                          ...
                          <div class="col-md-3"><br> <button type="button" class=" btn-primary btn-lg btnAnnuler" style="display: none;" onclick="annulerSuppressionGazoil();">Annuler</button> 
                           ...
                           echo'<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addFraisAchat(\'insert\');">Valider</button>'; }
                           ?></div>
                        </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getFraisAchatParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getFraisAchatParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Liste des frais achats</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: DEPENSE FRAIS DIVERS'
            },
            {
            extend: "pdf",
