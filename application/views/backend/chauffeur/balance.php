      ...
      <div class="col-4 col-sm-4">
                    ...
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-danger">
                      <div class="card-header">
                        <h3 class="card-title">Sélectionnez un chauffeur</h3>
                      </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <select class="camion code_camion form-control" onchange=" getChauffeurParCodeCamion2();" onselect="">
                                <option></option>
                            ...
                            <select class="id_fournisseur form-control contentChauffeur" disabled="true" onchange="" >
                             <option value=""></option>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control montant_init" disabled="true" name="">
                          </div>
                          <div class="form-group">
                            <label>Date</label>
                            <div class="input-group " id="" data-target-input="nearest" >
                              
                                <input type="text" class="form-control date_init" data-target="#reservationdate" disabled="true" />
                     ...
                     <div class="card card-warning">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">          
                            Σ(Imputations) : <input type="text" disabled="true" class="totalFacture form-control" name="">
                            Σ(Règlements) : <input type="text" disabled="true"  class="totalReglement form-control" name="">
          ...
          <div class="col-4 col-sm-4">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceChauffeur();"/>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getBalanceChauffeur();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
            ...
            <div class="col-12 col-sm-6" >
              <h3 style="text-align: center;">Imputations</h3>
                     <hr>
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: IMPUTATIONS SALARIALE'
            },
            {
            extend: "pdf",
        ...
        buttons: [
         {
            ...
            className: "btn btn-white btn-primary btn-bold",
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: REGLEMENT DES IMPUTATIONS'
            },
            {
            extend: "pdf",
            text: "<i class='fa fa-file-pdf-o bigger-110 red'></i> <span class='hidden'>Exporte en pdf</span>",
