        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionDemandeNA();">Confirmer</button>
                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        ...
                        <div class="col-md-2" >
                           ...
                           <input type="text" class="form-control po" disabled="true" name="" value="<?php echo $this->crud_model_depense->genererChaineAleatoireDemandeNA();?>">
                          </div>
                          </div>
		        ...
		        ?>					
						...
						<hr>
						  ...
						  <div class="col-md-1">
                            ...
                            <select class="form-control nbreLigne" onchange="afficheLigneDemandeNavetteAutre();">
                              <option>0</option>
                              <option>1</option>
                              <option>2</option>
                              <option>3</option>
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addDemandeNA('update');">Modifier</button>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addDemandeNA(\'insert\');">Valider</button>'; } ?></div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange=" getAllDemandeNA('#example1');" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getAllDemandeNA('#example1');" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
