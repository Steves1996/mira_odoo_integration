                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                            ...
                            <select class="code_camion form-control" onchange=" selectAllDistanceType('#example1'); getLitrage();">
                                <option></option>
                          ...
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control distance" placeholder="Destination">

                          </div>
						  
						   <div class="col-md-3">
                            <label>distance Théorique</label>
                            <input type="text" class="form-control kilometrage" placeholder="Distance TH"  onkeypress="chiffres(event);" onkeyup ="formatMillier('kilometrage');"  onchange="getMontantTotal();" />

                          </div>
						  
						  <div class="col-md-3">
                            <label>Coefficient</label>
                            <input type="text" class="form-control littrage_unitaire" placeholder="Coefficient"  onkeypress="chiffres(event);"   disabled = "true" onchange="getMontantTotal();" />

                          </div>
						  
                          <div class="col-md-3">
                            <label>Littrage Total</label>
                            <input type="text" class="form-control littrage" placeholder="Littrage"  onkeypress="chiffres(event);" onkeyup ="formatMillier('littrage');" value = "0" disabled = "true">

                          </div>
                          <div class="col-md-3">
                            <label>Frais Route</label>
                            <input type="text" class="form-control route" placeholder="Frais Route  en FCFA" onkeypress="chiffres(event);" onkeyup ="formatMillier('route');" placeholder="Frais Route">

                          </div>
                          <div class="col-md-3">
                            <label>Frais Retour</label>
                            <input type="text" class="form-control retour" onkeypress="chiffres(event);" onkeyup ="formatMillier('retour');" placeholder="Frais Retour en FCFA">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addDistance('update');">Modifier</button>
                          </div>
                         ...
                         <?php
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addDistance(\'insert\');">Valider</button>'; } ?></div>
                        </div>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">Liste des Destinations</h3>
                  ...
                  <tr >
                    ...
                    <th>LITTRAGE</th>
                    <th>FRAIS RETOUR</th>
					 <th>FRAIS ROUTE <i class="nav-icon fas fa-exchange-alt"></i></th>
                    <th>Action</th>
                  </tr>
                  </thead>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: DESTINATION LITTRAGE'
            },
            {
            extend: "pdf",
