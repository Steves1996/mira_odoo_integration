                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <label>Camion</label>
                            <select class="camion form-control id_fournisseur" onchange="amortissement();">
                              <option value=""></option>
                     ...
                     <div class="card card-warning">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                             Matricule : <input type="text" disabled="true"  class="matricule form-control" name="">        
                            Prix d'achat : <input type="text" disabled="true" class="achat form-control" name="">
                           
                            Cumul amortissement : <input type="text" disabled="true" class="cumul form-control" name="">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet" onchange="" />
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet" onchange="" />
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                  ...
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">AMORTISSEMENT</h3>
                     ...
                     <div class="overlay-wrapper">
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <input type="text" class="dernierInventaire" name="" value="<?php $this->crud_model_stock->getDateDernierInventaire(); ?>" disabled="true">
                  <thead>
                  <tr >
                    <th onclick="">N°</th>
                    <th>Code</th>
                    ...
                    <th>Quantité</th>
                    <th>Amortissement unitaire (FCFA)</th>
                    <th>Cout total (FCFA)</th>
                    <!-- <th>Stock</th> -->
                  </tr>
                  </thead>
                  <tbody class="contentClient">
                 <?php
                 // $this->crud_model_stock->stockArticle();
                  ?>
                  </tbody></table>
                    </div>
                        </div>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: AMORTISSEMENT'
            },
            {
            extend: "pdf",
