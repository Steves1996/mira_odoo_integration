                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                            ...
                            <label>Véicule</label>
                            <select class="camion form-control id_fournisseur" onchange="getChaufeurEtImmariculation();">
                          ...
                          <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <div class="input-group " id="" data-target-input="nearest" >
                                        <input type="date" class="form-control datetimepicker-input date_distance" data-target="#reservationdate" placeholder="date effet"/>
                           ...
                           <div class="form-group">
                            ...
                            <input type="text" class="form-control chauffeur" disabled="true" name="">
                          </div>
                          </div>
                           <div class="col-md-3">
                          <div class="form-group">
                            <label>Immatriculation</label>
                            <input type="text" class="form-control immatriculation" disabled="true" name="">
                          </div>
                          </div>
                          
                          <div class="col-md-3">
                            <label>Kilometrage debut mois</label>
                            <input type="text" class="form-control kilometrage_debut" placeholder="Kilometrage de debut du mois" onkeyup ="formatMillier('kilometrage_debut'); distanceParcourue();" onkeypress="chiffres(event);">

                          </div>
                          <div class="col-md-3">
                            <label>Kilometrage fin mois</label>
                            <input type="text" class="form-control kilometrage_fin" placeholder="Kilometrage de fin du mois" onkeypress="chiffres(event);" onkeyup ="formatMillier('kilometrage_fin');  distanceParcourue();">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control distance_parcourue" disabled="true" name="">
                          </div>
                          </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            <label>Commentaire</label>
                            <textarea class="form-control commentaire" name=""></textarea>
                          </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addDistanceParcourue('update');">Modifier</button>
                          </div>
                         ...
                         <?php
                            if ($this->session->userdata('distance_ajout')=="true") {
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addDistanceParcourue(\'insert\');">Valider</button>';} ?>
                          </div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionDistanceParcourue();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">Liste des distances parcourue</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: LISTE DES CLIENTS'
            },
            {
            extend: "pdf",
