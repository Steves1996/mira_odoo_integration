                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;" >ENREGISTREMENT CONTROLE DES FRAIS DE ROUTE</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <a href="#details"></a>
                      <div class="card-body">
                        <h2 style="text-align: center" id="details">Entête des Controles Frais de Route</h2>
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_demande" data-target="#reservationdate" placeholder="date effet" disabled  = "false" />
				...
				if($this->session->userdata('identifiant')=='nathan' ) {
                   ...
                   echo'  <div class="col-md-1">
					 ...
					 echo' <div class="col-md-1">
							...
							if($this->session->userdata('identifiant')=='CONTROLE' ) {
						
                   echo'  <div class="col-md-1">
                              <label>DGT</label>
                              <input type="checkbox" class="form-control rj1" disabled = "false"  >
                          </div> ';
					 ...
					 echo' <div class="col-md-1">
                              <label>DAF</label>
                              <input type="checkbox" class="form-control rj" disabled = "false">
                          </div> ';
		        ...
		        ?>					
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addDemande('update');">Modifier</button>
						   ...
						   <div class="col-md-4"><br> <button type="button" class=" btn-primary btn-lg btnAnnulerModif" style="display: none;" onclick="annulerSuppressionGazoil();">Annuler</button></div>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Liste des Controles Demandes de Frais de Route</h3>
                 ...
                 <?php
                 $this->crud_model_depense->selectAllContoleDemmande();
                  ?>
                  </tbody></table>
                    </div>
