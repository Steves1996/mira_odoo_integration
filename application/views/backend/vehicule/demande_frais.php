        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionDemande();">Confirmer</button>
      ...
      <div class="col-12 col-sm-12">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;" >ENREGISTREMENT DES FRAIS DE ROUTE</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <a href="#details"></a>
                      <div class="card-body">
                        <h2 style="text-align: center" id="details">Entête des Frais de Route</h2>
                        <div class="row">
				 ...
				 echo' <div class="col-md-1">
                   ...
                   echo'  <div class="col-md-1">
					...
					if( $this->session->userdata('identifiant')=='HADI'  ) {
				...
				if($this->session->userdata('identifiant')=='nathan' ) {
                   ...
                   echo'  <div class="col-md-1">
					...
					if($this->session->userdata('identifiant')=='STEVE' ) {
		        ...
		        ?>					
						...
						<hr>
                        <h2 style="text-align: center">Détails de la Demande des frais de route</h2>
						<hr>
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addDemande('update');">Modifier</button>
						   ...
						   <div class="col-md-4"><br> <button type="button" class=" btn-primary btn-lg btnAnnulerModif" style="display: none;" onclick="annulerSuppressionGazoil();">Annuler</button> 
                            <?php
                            if ($this->session->userdata('demande_ajout')=="true") {
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addDemande(\'insert\');">Valider</button>'; } ?></div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange=" getAllDemande('#example1');" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getAllDemande('#example1');" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
					    ...
					    <div class="col-md-3" >
                            <div class="form-group">
                            <label>Délégué</label>
                            <select class="id_fournisseur1 form-control" onchange="getAllDemande('#example1');">
               ...
               <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Détail de la demande des frais de route</h3>
                        <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i>
                        </button>
                      </div>
                  ...
                  <tr style=" margin: 0px;">
                    <td onclick="" colspan="3" style=" margin: 0px;border: none; border-bottom: 2px solid black; ">
                          ...
                          <span style="font-size: 25px; border: none; font-weight: bold;">DEMANDES FRAIS ROUTE</span><br/>
                  ...
                  <tr>
                    ...
                    <td style="margin: 0px; padding: 0px;border: none;width: 18%" colspan="2">Etat DAF :</td> 
                  ...
                  <tr>
                    ...
                    <td style="margin: 0px; padding: 0px;border: none; border: none;width: 10%" colspan="2">Etat DGT :</td> 
                 ...
                 <!--  <td style="border-bottom: : 1px solid black;width: 10%; text-align: center;border-bottom: 3px solid black; ">PO(item)</td>
					...
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 7%; text-align: center;border-bottom: 1px solid black; ">Date BL</td>
                    ...
                    <td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 10%; text-align: center;border-bottom: 1px solid black; ">Matricule</td>
					...
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 10%; text-align: center;border-bottom: 1px solid black; ">M.Départ</td>
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 5%; text-align: center;border-bottom: 1px solid black; ">F.Route</td>
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 10%; text-align: center;border-bottom: 1px solid black; ">M.Retour</td>
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 5%; text-align: center;border-bottom: 1px solid black; ">F.Retour</td>
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 3%; text-align: center;border-bottom: 1px solid black; ">N.TR</td>
                    <td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 5%; text-align: center;border-bottom: 1px solid black; ">Surcharge</td>
