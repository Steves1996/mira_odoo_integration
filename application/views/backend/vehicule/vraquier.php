        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionVraquier();">Confirmer</button>
                   ...
                   <div class="col-sm-6">
                    ...
                    <div class="col-sm-4">
                            ...
                            <select class="type_camion form-control">
                                ...
                                <?php $this->crud_model_vehicule->leSelectTypeVraquier(); ?>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
               ...
               <?php
                          ...
                          echo ' <button type="button" class=" btn-primary btn-lg"  onclick="addVraquier(\'insert\');">Enregistrer</button>';} ?>
                    ...
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-header">
                        ...
                        <h3 class="card-title">Liste des vraquiers</h3>
