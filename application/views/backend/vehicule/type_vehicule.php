                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control nom_type" placeholder="Nom du type">
                          ...
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control montant" placeholder="" onkeyup ="formatMillier('montant');" />

                          </div>
                          <div class="col-md-3">
                            <label>Distance minimale</label>
                            <input type="text" class="form-control distance_minimale" placeholder="">
                          ...
                          <!-- <div class="col-md-3">
                            <input type="text" class="form-control nui" placeholder="NUI">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addTypeVehicule('update');">Modifier</button>
                          </div>
                        ...
                        <?php
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addTypeVehicule(\'insert\');">Valider</button>'; } ?>
                        </div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionTypeVehicule();">Confirmer</button>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: TYPE VEHICULE'
            },
            {
            extend: "pdf",
