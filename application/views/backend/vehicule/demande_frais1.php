              ...
              <h3 style="text-align: center;">VISUALISATION</h3>
               ...
               <div class="tab-content" id="custom-tabs-one-tabContent">
                  ...
                  <tr style=" margin: 0px;">
                    ...
                    <td colspan="12" style="margin: 0px; padding: 0px;border: none;"><br/><br/></td></tr>
					
                  <tr><td colspan="12" style="margin: 0px; padding: 0px;border: none;"></td></tr>
                 ...
                 <!--  <td style="border-bottom: : 1px solid black;width: 10%; text-align: center;border-bottom: 3px solid black; ">PO(item)</td>
					...
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 5%; text-align: center;border-bottom: 1px solid black; ">N.Tour</td>
