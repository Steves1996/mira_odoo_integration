        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionRemorque();">Confirmer</button>
              ...
              <h3 style="text-align: center;">VISUALISATION</h3>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  ...
                  <tr >
                    ...
                    <th>N° carte grise</th>
                    <th>N° carte bleue</th>
                    <th>N° Visite technique</th>
					<th>DESACTIVITE</th>
                    <th>Options</th>
                  </tr>
                  </thead>
                  <tbody class="contentRemorque">
                 <?php
                 $this->crud_model_vehicule->selectAllRemorque();
                  ...
                  <input type="hidden" value="" class="id_remorque" name="">
                </div>
