        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionDemandeE();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;" >ENREGISTREMENT DE GAZOIL ENGIN</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <a href="#details"></a>
                      <div class="card-body">
                        <h2 style="text-align: center" id="details">Entête De Gazoil Engin</h2>
                        <div class="row">
                        ...
                        <div class="col-md-2" >
                           ...
                           <input type="text" class="form-control po" disabled="true" name="" value="<?php echo $this->crud_model_depense->genererChaineAleatoireDemandeE();?>">
                          </div>
                          </div>
                         ...
                         <div class="col-md-3">
                           ...
                           <select class="form-control operation" onchange="">
                            <?php $this->crud_model_depense->leSelectOperationEngin(); ?>
		        ...
		        ?>					
						...
						<hr>
						  ...
						  <div class="col-md-1">
                            ...
                            <select class="form-control nbreLigne" onchange="afficheLigneDemandeEngin();">
                              <option>0</option>
                              <option>1</option>
                              <option>2</option>
                              <option>3</option>
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addDemandeE('update');">Modifier</button>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addDemandeE(\'insert\');">Valider</button>'; } ?></div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange=" getAllDemandeE('#example1');" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getAllDemandeE('#example1');" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
					    ...
					    <div class="col-md-3" >
                            <div class="form-group">
                            <label>Délégué</label>
                            <select class="id_fournisseur1 form-control" onchange="getAllDemandeE('#example1');">
               ...
               <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Détail de la demande de gazoil engin</h3>
                        <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i>
                        </button>
                      </div>
                  ...
                  <tr style=" margin: 0px;">
                    <td onclick="" colspan="3" style=" margin: 0px;border: none; border-bottom: 2px solid black; ">
                          ...
                          <span style="font-size: 25px; border: none; font-weight: bold;">DEMANDES GAZOIL ENGIN</span><br/>
