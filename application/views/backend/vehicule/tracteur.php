    ...
    <section class="content">
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionTracteur();">Confirmer</button>
     ...
     <div class="row ">
                 ...
                 <div class="row">
                   <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control kilometrage" onkeypress="chiffres(event);" placeholder="kilometrage">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control puissance" onkeypress="chiffres(event);" placeholder="Enter ...">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                   ...
                   echo'        <div class="col-sm-6">
                            ...
                            <select class="type_camion form-control">';
                                $this->crud_model_vehicule->leSelectTypeTracteur(); 
                    echo '  </select>
                   ...
                   echo'        <div class="col-sm-6">
                    ...
                    echo '  </select>
                            ...
                            <div class="form-group">
                            <label>Type de Tracteur</label>
                            <select class="type_camion form-control" disabled = "true">
                             <option >Ancien</option>
                                </select>
					...
					<div class="col-sm-6">
                      <div class="form-group">
                        <label>DELEGUE</label>
                        <input type="text" class="form-control delegue"  placeholder="delegue">
                      </div>
                    </div>
         ...
         <div class="col-md-12">
                  ...
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">Liste des Tracteurs</h3>
                        <div class="card-tools">
          ...
          <input type="hidden" class="id_tracteur" name="">
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: TRACTEURS'
            },
            {
            extend: "pdf",
