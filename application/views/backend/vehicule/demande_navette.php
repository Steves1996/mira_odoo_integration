        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionDemandeN();">Confirmer</button>
     ...
     <div class="row">
      <div class="col-12 col-sm-12">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;" >ENREGISTREMENT DE GAZOIL NAVETTE</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <a href="#details"></a>
                      <div class="card-body">
                        <h2 style="text-align: center" id="details">Entête De Gazoil Navette</h2>
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_demande" data-target="#reservationdate" placeholder="date effet" onchange="getExpirationPneu();" />
                        ...
                        <div class="col-md-2" >
                           ...
                           <input type="text" class="form-control po" disabled="true" name="" value="<?php echo $this->crud_model_depense->genererChaineAleatoireDemandeN();?>">
                          </div>
                          </div>
                         ...
                         <div class="col-md-3">
                           ...
                           <select class="form-control operation" onchange="">
                             <option value="0"></option>
                              <?php $this->crud_model_depense->leSelectOperationNavette(); ?>
                          ...
                          <div class="col-md-1">
						   ...
						   <div class="col-md-1">
                             <div class="form-group">
                            <label>Demande LOGS</label>
                           <input type="text" class="form-control etat_demande1" disabled="true" name="" value="DEMANDE">
                          </div>
                          </div>
				 ...
				 echo' <div class="col-md-1">
                              ...
                              <input type="checkbox" class="form-control rj2" disabled = "true">
                          </div> ';
                   ...
                   echo'  <div class="col-md-1">
					 ...
					 echo' <div class="col-md-1">
                        ...
                        }else if( $this->session->userdata('identifiant')=='HADI'  ) {
                   ...
                   echo'  <div class="col-md-1">
					 ...
					 echo' <div class="col-md-1">
                              <label>LOGISTIC</label>
                              <input type="checkbox" class="form-control rj2" >
                          </div> ';
                   ...
                   echo'  <div class="col-md-1">
                              <label>DGT</label>
                              <input type="checkbox" class="form-control rj1 disabled = "true" checked = "true" >
                          </div> ';
					 ...
					 echo' <div class="col-md-1">
                              <label>DAF</label>
                              <input type="checkbox" class="form-control rj disabled = "true" checked = "true" >
                          </div> ';
						  
						  
					 echo' <div class="col-md-1">
                              <label>LOGISTIC</label>
                              <input type="checkbox" class="form-control rj2 disabled = "true" checked = "true" >
                          </div> ';
		        ...
		        ?>					
						...
						<hr>
                        <h2 style="text-align: center">Détails de la Demande des Frais de Gazoil Navette</h2>
						<hr>
						
						
						  <div class="col-md-1">
                            <label>Nbre Camions</label>
                            <select class="form-control nbreLigne" onchange="afficheLigneDemandeNavette();">
                              <option>0</option>
                              <option>1</option>
                              <option>2</option>
                              <option>3</option>
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addDemandeN('update');">Modifier</button>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addDemandeN(\'insert\');">Valider</button>'; } ?></div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange=" getAllDemandeN('#example1');" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getAllDemandeN('#example1');" value="<?php echo date('Y-m-d'); ?>"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
					    ...
					    <div class="col-md-3" >
                            <div class="form-group">
                            <label>Délégué</label>
                            <select class="id_fournisseur1 form-control" onchange="getAllDemandeN('#example1');">
               ...
               <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Détail de la demande de gazoil navette Pouzzolane</h3>
                        <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i>
                        </button>
                      </div>
                  ...
                  <tr style=" margin: 0px;">
                    <td onclick="" colspan="3" style=" margin: 0px;border: none; border-bottom: 2px solid black; ">
                          ...
                          <span style="font-size: 25px; border: none; font-weight: bold;">DEMANDES GAZOIL NAVETTE</span><br/>
                  ...
                  <tr>
                    <td colspan="2" style="margin: 0px; padding: 0px;border: none;">N° Opération :</td> 
                    <td colspan="3" class="operation" style="margin: 0px; padding: 0px;border: none;">...</td> 
                    <td colspan="5" style="margin: 0px; padding: 0px;border: none;"></td>
                  ...
                  <tr>
                    ...
                    <td style="margin: 0px; padding: 0px;border: none;">Etat DAF :</td> 
                    <td class="etat_expedition2" style="margin: 0px; padding: 0px;border: none; text-align : center;colspan="2">...</td>  
                  ...
                  <tr>
                    ...
                    <td style="margin: 0px; padding: 0px;border: none; border: none;">Etat DGT :</td> 
                    <td class="etat_expedition3" style="margin: 0px; padding: 0px; border: none; text-align : center; colspan="2">...</td> 
                  </tr>
                 ...
                 <!--  <td style="border-bottom: : 1px solid black;width: 10%; text-align: center;border-bottom: 3px solid black; ">PO(item)</td>
                    ...
                    <td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 15%; text-align: center;border-bottom: 1px solid black; ">Opération</td>
					
                    <td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 7%; text-align: center;border-bottom: 1px solid black; ">Vehicule </td>
                    <td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 7%; text-align: center;border-bottom: 1px solid black; ">Matricule</td>
                    <td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 20%; text-align: center;border-bottom: 1px solid black; ">Client</td>
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 10%; text-align: center;border-bottom: 1px solid black; ">Destination</td>
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 10%; text-align: center;border-bottom: 1px solid black; ">Litrage</td>
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 10%; text-align: center;border-bottom: 1px solid black; ">Nbre BL(s)</td>
					
                    <td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 10%; text-align: center;border-bottom: 1px solid black; ">Total</td>
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 10%; text-align: center;border-bottom: 1px solid black; ">Station</td>
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 10%; text-align: center;border-bottom: 1px solid black; ">Sig.ADM</td>
					<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;width: 10%; text-align: center;border-bottom: 1px solid black; ">Sig.CHF</td>
