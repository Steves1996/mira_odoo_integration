        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionCamionBenne();">Confirmer</button>
                   ...
                   <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                            ...
                            <select class="type_camion form-control">
                                <?php $this->crud_model_vehicule->leSelectTypeBenne(); ?>
                                </select>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <?php
                          ...
                          echo ' <button type="button" class=" btn-primary btn-lg"  onclick="addCamionBenne(\'insert\');">Enregistrer</button>'; } ?>
               </form>
              </div>
              <!-- /.card-body -->
            </div>
                  ...
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">Liste des camions benne</h3>
                        <div class="card-tools">
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: CAMIONS BENNES'
            },
            {
            extend: "pdf",
