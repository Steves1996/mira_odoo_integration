                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                     ...
                     <div class="card card-success">
                      ...
                      <div class="card-body">
                        ...
                        <div class="col-md-12">
                           ...
                           <select class="operation form-control" onchange="">
                             <option value="0"></option>
                              <?php $this->crud_model_vehicule->leSelectOperation(); ?>
                          ...
                          <div class="form-group">
                              ...
                              <select class="camion code_camion form-control" onchange="">
                                <option></option>
                                <?php $this->crud_model_vehicule->leSelectCodeCamion(); ?>
                                </select>
                            </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_acc" data-target="#reservationdate" placeholder="date effet" onchange="" />
                         ...
                         <div class="col-md-12">
                            <label>Lieu Accident</label>
                            <input type="text" class="form-control lieu" placeholder="Lieu Accident">

                          </div>
                          
                           <div class="col-md-12">
                            <label>Espèce Dépensé</label>
                            <input type="text" class="form-control depense" placeholder=" En FCFA" onkeypress="chiffres(event);" onkeyup ="formatMillier('depense');">

                          </div>
                        
                         <div class="col-md-12">
                            <label>Date Entrée Garage</label>
                          <div class="input-group " id="" data-target-input="nearest" >
                              
                                <input type="date" class="form-control datetimepicker-input date_ent" data-target="#reservationdate" placeholder="date entrée" onchange="" />
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                         ...
                         <div class="col-md-12">
                            <label>Date Sortie Garage</label>
                          <div class="input-group " id="" data-target-input="nearest" >
                              
                                <input type="date" class="form-control datetimepicker-input date_sort" data-target="#reservationdate" placeholder="date sortie" onchange="" />
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-sm-12 col-md-12">
                            <table class="table table-bordered table-striped">
                              ...
                              <tbody class="contentAddInventaire">
                    ...
                    <div class="col-md-12">
                            ...
                            <input type="text" class="form-control depensetotal" placeholder=" En FCFA" disabled="true" onkeypress="chiffres(event);" onkeyup ="formatMillier('depensetotal');">
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionAccident();">Confirmer</button>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="$('#example10').DataTable().destroy(); selectAllAccident('#example10');"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="$('#example10').DataTable().destroy(); selectAllAccident('#example10');"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="col-md-3">
                           <div class="form-group">
                            ...
                            <select class="code_camion1 form-control" onchange="$('#example10').DataTable().destroy(); selectAllAccident('#example10');">
                             <option></option>
                              <?php $this->crud_model_vehicule->leSelectCodeCamion();?>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title">LISTE DES ACCIDENTS</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: ACCIDENTS'
            },
            {
            extend: "pdf",
