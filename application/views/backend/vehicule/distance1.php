                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                            ...
                            <select class="code_camion form-control" onchange=" selectAllDistanceType('#example1');">
                                <option></option>
                            ...
                            <label>Littrage / KM</label>
                            <input type="text" class="form-control littrage_unitaire" placeholder="Littrage_unitaire"  onkeypress="chiffres(event);" onkeyup ="formatMillier('littrage_unitaire');"  onchange="" />
                        ...
                        <div class="row">
                         ...
                         <?php
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addDistance1(\'update\');">Modifier</button>'; } ?></div>
                        </div>
