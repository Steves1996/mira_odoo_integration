                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-3">
                            ...
                            <select class="id_fournisseur form-control" onchange="totauxPourCloture();">
                          ...
                          <div class="col-md-3">
                            <label>Date : </label>
                          <div class="input-group " id="" data-target-input="nearest" onchange="totauxPourCloture();">
                              
                                <input type="date" class="form-control datetimepicker-input date_article" data-target="#reservationdate" placeholder="date effet"  />
                          ...
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control facture"  placeholder="Total Entrée" disabled="true">
                          </div>
                          <div class="col-md-3">
                            <label>Total Règlement</label>
                            <input type="text" class="form-control reglement" placeholder=" Total Sortie" disabled="true">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addClotureArticle('update');">Modifier</button>
                          </div>
                          <div class="col-md-4 alertSucces">
                           ...
                           <?php
                            if ($this->session->userdata('article_ajout')=="true") {
                          echo ' <button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addClotureArticle(\'insert\');">Valider</button>'; }?>
                          </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionClotureArticle();">Confirmer</button>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: CLOTURE CAISSE'
            },
            {
            extend: "pdf",
