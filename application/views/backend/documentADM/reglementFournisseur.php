...
<head>
  ...
  $reglementDocument="";
 $ouvertFournisseurDocument="";
  $activeFournisseurDocument="";
  ?></title>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionReglementArticle();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;">REGLEMENT DES FACTURES</h3>
                     <hr>
                      ...
                      <div class="card-body">
                        <div class="row">
						 ...
						 <div class="col-md-3">
						  ...
						  <label>Type Reglement Article</label>
						...
						<div class="col-md-3">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input dateFacture" data-target="#reservationdate" placeholder="date effet"  />
                          ...
                          <div class="col-md-3">
                            ...
                            <select class="id_gazoil form-control id_fournisseur" onchange="">
						   ...
						   <div class="col-md-3">
                             <label>numéro</label>
                            <input type="text" class="form-control numero" placeholder="Numero Règlement"  disabled="true" name="" value="<?php echo $this->crud_model_article->genererChaineAleatoireReglementArticle();?>">
                          ...
                          <div class="col-md-2">
                            ...
                            <input type="text" class="form-control cheque" placeholder="Numero Chèque" disabled = "true">
                        ...
                        <div class="form-group">
                            <label>Banque</label>
                            <input type="text" class="form-control banque" name="Nom Banque" disabled = "true">
                          </div>

                          </div>
						  
						   <div class="col-md-2" >
                           <label>Qté Ciment</label>
                            <input type="text" class="form-control ciment"  placeholder=" en FCFA" disabled = "true" onkeypress="chiffres(event);" onkeyup ="formatMillier('ciment');" onchange="getMontantTotal();" />

                          </div>
						  
						   <div class="col-md-2" >
                           <label>Prix Unitaire</label>
                            <input type="text" class="form-control pu"  placeholder=" en FCFA" onkeypress="chiffres(event);" disabled = "true" onkeyup ="formatMillier('pu');" onchange="getMontantTotal();" />
                       ...
                       <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <label>Libelle</label>
                            <input type="text" class="form-control libelle" name="">
                          </div>
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addReglementArticle('update');">Modifier</button>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addReglementArticle(\'insert\');">Valider</button>'; } ?></div>
                        </div>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Liste Des Règlements</h3>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: REGLEMENT FOURNISSEUR'
            },
            {
            extend: "pdf",
