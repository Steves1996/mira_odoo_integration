                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <select class="id_fournisseur form-control" onchange="rapportFacture();">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="rapportFacture();"/>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="rapportFacture();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <input class="custom-control-input cloturer" type="checkbox" id="customCheckbox2" onclick="rapportFacture();">
                          <label for="customCheckbox2" class="custom-control-label">Régler</label>
                        </div>
                          </div>
                    ...
                    <thead>
                      <tr ><th style="border: 5px solid #0e2d86; border-right: none; border-left: none;"></th>
                        ...
                        <table cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td colspan="12" style="color: blue; font-weight: bold; font-size: 25px; text-align: center;">RECAPITULATIF DES FACTURES FOURNISSEURS</td>
                          </tr>
                      ...
                      <tr  style="size: 10px; border: 2px solid black; text-align: center;">
                        ...
                        <th style="size: 10px; border: 2px solid black;">Fournisseur</th>
                        <th style="size: 10px; border: 2px solid black;">Bon Liv</th>
                        <th style="size: 10px; border: 2px solid black;">Date</th>
                        <th style="size: 10px; border: 2px solid black;">Numéro</th>
                        <th style="size: 10px; border: 2px solid black;">Montant</th>
                        <th style="size: 10px; border: 2px solid black;">Remise</th>
                        <th style="size: 10px; border: 2px solid black;">TOTAL</th>
                        <th style="size: 10px; border: 2px solid black;">Echéance</th>
                        <th style="size: 10px; border: 2px solid black;">Cloturer</th>
