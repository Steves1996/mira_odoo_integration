     ...
     <div class="row">
                    ...
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                           ...
                           <textarea class="commentaire form-control" placeholder="Commantaire"></textarea>
                            ...
                            <input type="text" class="form-control montant_init"  onkeyup ="formatMillier('montant_init');" placeholder="Solde Initial">
                         ...
                         <div class="col-md-3">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_init" data-target="#reservationdate" placeholder="date effet" value="<?php echo date('Y-m-d'); ?>"/>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <br>  <button type="button" class=" btn-primary btn-lg btnModifClient" style="display: none;"  onclick="addFournisseurArticle('update');">Modifier</button>
                          </div>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAddClient"  onclick="addFournisseurArticle(\'insert\');">Valider</button>'; } ?>
                          </div>
                        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionFournisseurArticle();">Confirmer</button>
        ...
        <!-- /.modal-dialog -->
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                 ...
                 <?php
                 $this->crud_model_article->selectAllFournisseurDocument();
                  ?>
                  </tbody></table>
                    </div>
                        </div>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: FOURNISSEUR ARTICLE'
            },
            {
            extend: "pdf",
