                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            ...
                            <!-- <select class="id_fournisseur form-control" onchange="selectAllFactureParFournisseur('#example1');"> -->
                                
                            <select class="id_fournisseur form-control" onchange="leSelectBLParFournisseur();">
                        ...
                        <div class="col-md-4">
                           <label>Remise</label>
                            <input type="text" class="form-control remise" placeholder=" en FCFA" onkeypress="chiffres(event);" onkeyup ="formatMillier('montant');">

                        </div>
                        
                        <div class="col-md-3">
                            <label>Echéancier : </label>
                          <div class="input-group " id="" data-target-input="nearest" >
                              
                                <input type="date" class="form-control datetimepicker-input echeance" data-target="#reservationdate" placeholder="date effet"  />
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addFactureArticle('update');">Modifier</button>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addFactureArticle(\'insert\');">Valider</button>'; }?>
                          </div>
                        </div>
        ...
        buttons: [
         {
            ...
            autoPrint: true,
            message: 'MIRA TRANSPORT :::: FACTURE FOURNISSEUR'
            },
            {
            extend: "pdf",
