        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionDepensePneu();">Confirmer</button>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <h3 style="text-align: center;" >ENREGISTREMENT DE LA SORTIE PIECE PNEU</h3>
                     <hr>
                     <div class="card card-info">
                      ...
                      <a href="#details"></a>
                      <div class="card-body">
                        <h2 style="text-align: center" id="details">Entête de la Dépense</h2>
						<hr>
                        <div class="row">
                      <div class="col-md-3">
						  ...
						  <div class="col-md-3">
						   <div class="form-group">
                            ...
                            <select class="id_fournisseur1 form-control" >
                          ...
                          <div class="col-md-3">
                           <div class="form-group">
                              <label>Article</label>
                              <select autocomplete="20" class="article form-control" onchange="getPrixUnitaireArticlePourPneu();">
                                <option value=""></option>
                                <?php $this->crud_model_depense->leSelectArticle2(); ?>
                                </select>
                            </div>
                          </div>
                        ...
                        <div class="col-md-3">
                         ...
                         <input type="text" name="" placeholder="Prix unitaire " class="PU form-control"  onkeypress="chiffres(event); " onkeyup ="formatMillier('PU'); getPrixTotalPourPieceRechange();">
                          </div>
						  <div class="col-md-3">
                            <label>Quantité</label>
                            <input type="text" placeholder="quantité" name="" class="form-control qtite" onkeypress="chiffres(event);" onkeyup="getPrixTotalPourPieceRechange();">
                         
                             
                          </div>
                          <div class="col-md-3">
                            <label>Prix Total</label>
                            <input type="text" name="" placeholder="Prix unitaire " class="PT form-control" disabled="true" onkeypress="chiffres(event);" onkeyup ="formatMillier('PT');">
                        ...
                        <div class="row">
                         <!--  <div class="col-md-3">
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addDepensePneu('update');">Modifier</button>
                          ...
                          echo '<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addDepensePneu(\'insert\');">Valider</button>'; } ?></div>
                        </div>
                        </div>
                        ...
                        <hr>
                        <h2 style="text-align: center">ENREGISTREMENT DE LA SORTIE DU PNEU</h2>
                         <hr>
						 <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input datePrime1" data-target="#reservationdate" placeholder="date effet" onchange="getExpirationPneu();" />
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
					   ...
					   <div class="row">
						 ...
						 <br>
                          ...
                          <button type="button" class=" btn-primary btn-lg btnModif" style="display: none;"  onclick="addDepensePneu1('update');">Modifier</button>
                          ...
                          <div class="col-md-4"><br> <button type="button" class=" btn-primary btn-lg btnAnnuler" style="display: none;" onclick="annulerSuppressionGazoil();">Annuler</button> 
                            <?php
                            if ($this->session->userdata('pneu_ajout')=="true") {
                          echo '<button type="button" class=" btn-primary btn-lg btnAdd"  onclick="addDepensePneu1(\'insert\');">Valider</button>'; } ?></div>
                         <br>
						</div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="getDepensePneuParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="getDepensePneuParDate();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">Liste des Dépense Pneu</h3>
