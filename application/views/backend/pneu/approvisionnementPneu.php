                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_inv" data-target="#reservationdate" value = "date('d-m-y h:i:s')" placeholder="date effet" onchange="" />
                          ...
                          <div class="col-md-12">
                            <label>Auteur</label>
                            <input type="text" class="form-control auteur" placeholder="Auteur" value = "LA DIRECTION">
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" class="btn btn-outline-light" data-dismiss="modal" onclick="confirmSuppressionApprovisionnementPneu();">Confirmer</button>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="$('#example10').DataTable().destroy(); selectAllApprovisionnementPneu('#example10');"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="$('#example10').DataTable().destroy(); selectAllApprovisionnementPneu('#example10');"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                          ...
                          <div class="col-md-3">
                           <div class="form-group">
                            <label>Fournisseur :</label>
                            <select class="id_fournisseur1 form-control" onchange="$('#example10').DataTable().destroy(); selectAllApprovisionnementPneu('#example10');">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                            <label>BL :</label>
                            <input type="text" class="form-control bl1" placeholder="bl" disabled="true" onkeyup="$('#example10').DataTable().destroy(); selectAllApprovisionnementPneu('#example10');">
