                  ...
                  <table class="table table-bordered table-striped" cellpadding="0" cellspacing="0">
                    <thead>
                      ...
                      <tr  style="size: 10px; border: 2px solid black;">
                        ...
                        <th style="size: 10px; border: 2px solid black;">FRAIS DIV</th>
                        <th style="size: 10px; border: 2px solid black;">FRAIS RTE</th>
                        <th style="size: 10px; border: 2px solid black;">GASOIL</th>
                        <th style="size: 10px; border: 2px solid black;">PCES + DEPAN</th>
                        <th style="size: 10px; border: 2px solid black;">PNEUS</th>
                        <th style="size: 10px; border: 2px solid black;">VIDANGE</th>
                        ...
                        <th style="size: 10px; border: 2px solid black;">CH R</th>
                        
                        <th style="size: 10px; border: 2px solid black;">LOC EN</th>
                        <!-- <th style="size: 10px; border: 2px solid black;">CHIF  D'AFF</th> -->
                        <th style="size: 10px; border: 2px solid black;">KILOMETRES</th>
                        <th style="size: 10px; border: 2px solid black;">BENEFICE</th>
