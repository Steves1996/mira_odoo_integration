                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <select class="id_fournisseur form-control" onchange="getBalancePourOperation();">
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="custom-tabs-one-carte" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab ">
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-info">
                      <div class="card-header">
                        <h3 class="card-title" style="text-align: center;">VENTE DIVERSES</h3>
                    ...
                    <div class="overlay-wrapper">
                     ...
                     <div class="overlay-wrapper" style="">
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        <label>Total :</label>
                  <input type="text" name="" style="color:red" class="totalFacture1" disabled="true">
                  <thead>
                  <tr >
                    <th onclick="">N°</th>
                    <th>Numéro</th>
