                    ...
                    <div class="overlay-wrapper">
                     ...
                     <div class="card card-danger">
                      <div class="card-header">
                        <h3 class="card-title">Sélectionnez un véhicule</h3>
                      </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <select class="code_camion form-control" onchange="EnteteRapportAccident();">
                              <option></option>
                              <?php $this->crud_model_rapport->vehicules(); ?>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="rapportCumuleMensuelAccident();"/>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="rapportCumuleMensuelAccident();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                    ...
                    <thead>
                      <tr ><th style="border: 5px solid #0e2d86; border-right: none; border-left: none;"></th>
                        ...
                        <table cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td colspan="12" style="color: blue; font-weight: bold; font-size: 25px; text-align: center;">RECAPITULATIF DES ACCIDENTS</td>
                          </tr>
                          <tr class="contentCamion">
                            <td>Code:  </td>
                      ...
                      <table id="example1" class="table table-bordered table-striped contentClient">
                        <thead>
