                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="rapportGeneral();"/>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="rapportGeneral();"/>
                  ...
                  <table class="table table-bordered table-striped" cellpadding="0" cellspacing="0">
                    ...
                    <thead>
                      ...
                      <tr ><th style="border: 5px solid #0e2d86; border-right: none; border-left: none;"></th>
                        ...
                        <table cellpadding="0" cellspacing="0" border="1px">
                          ...
                          <tr>
                            ...
                            <td colspan="12" style="color: blue; font-weight: bold; font-size: 25px; text-align: center;">RECAPITULATIF GENERAL DES VEHICULES</td>
                      ...
                      <tr  style="size: 10px; border: 2px solid black; text-align: center;">
                        ...
                        <th style="size: 10px; border: 2px solid black;">TYPE VEHICULE</th>

                        <th style="size: 10px; border: 2px solid black;">TRACTEUR 10 ROUES</th>

                        <th style="size: 10px; border: 2px solid black;">TRACTEUR 6 ROUES</th>

                        <th style="size: 10px; border: 2px solid black;">CAROSSERIE</th>

                        <th style="size: 10px; border: 2px solid black;">CALABRAISE</th>

                        <!-- <th style="size: 10px; border: 2px solid black;">NOUVEAUX CALABRAISE</th> -->

                       <!--  <th style="size: 10px; border: 2px solid black;">ANCIENNES CAROSSERIES</th>

                        <th style="size: 10px; border: 2px solid black;">NOUVELLES CAROSSERIES</th> -->

                        <th style="size: 10px; border: 2px solid black;">BENNES</th>
                        <th style="size: 10px; border: 2px solid black;">VRAQUIER</th>
                        <th style="size: 10px; border: 2px solid black;">SERVICE</th>
                        <th style="size: 10px; border: 2px solid black;">ENGIN</th>

                        <th style="size: 10px; border: 2px solid black; color: red;" >TOTAL</th>
