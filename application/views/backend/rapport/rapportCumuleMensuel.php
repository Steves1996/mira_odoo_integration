                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <select class="id_fournisseur form-control" onchange="rapportCumuleMensuel();">
                             <option value="0"></option>
                              <?php $this->crud_model_rapport->leSelectTypeVehicule(); ?>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="rapportCumuleMensuel();"/>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="rapportCumuleMensuel();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                    ...
                    <thead>
                      <tr ><th style="border: 5px solid #0e2d86; border-right: none; border-left: none;"></th>
                        ...
                        <table cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td colspan="12" style="color: blue; font-weight: bold; font-size: 25px; text-align: center;">RECAPITULATIF MENSUEL DES PLATEAUX</td>
                          </tr>
                        </table>
                      ...
                      <tr  style="size: 10px; border: 2px solid black; text-align: center;">
						...
						<th style="size: 10px; border: 2px solid black;">REMORQUE</th>
                        <th style="size: 10px; border: 2px solid black;">VGES</th>
                        <th style="size: 10px; border: 2px solid black;">AUTRES CHA</th>
                        ...
                        <th style="size: 10px; border: 2px solid black;">PRIME / Ration</th>
						<th style="size: 10px; border: 2px solid black;">COMMISSION</th>
						<th style="size: 10px; border: 2px solid black;">DEPANNAGE</th>
						<th style="size: 10px; border: 2px solid black;">PREV. NAV.</th>
						
                        <th style="size: 10px; border: 2px solid black;">ACDT</th>
                        <th style="size: 10px; border: 2px solid black;">BON_LIV</th>
                        <th style="size: 10px; border: 2px solid black;">CH_R</th>
                        <th style="size: 10px; border: 2px solid black;">VENTE PIECES</th>
                        ...
                        <th style="size: 10px; border: 2px solid black;">RESULTAT</th>
