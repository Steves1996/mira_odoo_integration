                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <!-- <div class="col-md-6">
                            ...
                            <select class="id_fournisseur form-control" onchange="rapportCumuleMensuelEN();">
                             <option value="0"></option>
                              <?php $this->crud_model_rapport->leSelectTypeVehicule2(); ?>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                            <label>ETAT</label>
                            <select class="etat form-control" onchange="rapportCumuleAN();">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_debut" data-target="#reservationdate" placeholder="date effet"  onchange="rapportCumuleAN();"/>
                          ...
                          <div class="input-group " id="" data-target-input="nearest" >
                                ...
                                <input type="date" class="form-control datetimepicker-input date_fin" data-target="#reservationdate" placeholder="date effet"  onchange="rapportCumuleAN();"/>
                                <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                          </div>
                  ...
                  <table class="table table-bordered table-striped" cellpadding="0" cellspacing="0">
                    <thead>
                      ...
                      <tr  style="size: 10px; border: 2px solid black; text-align: center;">
                        ...
                        <!-- 
                        <th style="size: 10px; border: 2px solid black;">ACCIDENT</th> 
                        -->
