                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            Entrées: <input type="text" disabled="true" class="totalEntree form-control" name="" value="<?php $this->crud_model_caisse->getMontantEntreeCaisse(); ?>">
                            Sorties : <input type="text" disabled="true"  class="totalSortie form-control" name="" value="<?php $this->crud_model_caisse->getMontantSortieCaisse(); ?>">
